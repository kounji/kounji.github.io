...
function inc_filter() {
    ...
    t += '\t\t\t\t\t<a href="javascript:void(0);" class="new btn bullet" title="new"><span>추가</span></a>',
...
function inc_IAHead() {
    ...
    t += "<colgroup>",
    t += '\t<col width="3%" /><!-- 1번호 -->',
    t += '\t<col class="depth2" style="width:10%" /><!-- 2Depth -->',
    t += '\t<col class="depth3" style="width:10%" /><!-- 3Depth -->',
    t += '\t<col class="depth4" style="width:10%" /><!-- 4Depth -->',
    t += '\t<col class="pid" style="width:10%" /><!-- 5메뉴명 -->',
    t += '\t<col class="page" style="width:6%" /><!-- 6화면ID -->',
    t += '\t<col class="path" style="width:8%" /><!-- 7경로 -->',
    t += '\t<col class="kind" style="width:3%" /><!-- 8작업구분 -->',
    t += '\t<col class="coder coder1" style="width:4%" /><!-- 9퍼블리셔 -->',
    t += '\t<col class="coder coder2" style="width:4%" /><!-- 10개발자 -->',
    t += '\t<col class="rdate" style="width:4%" /><!-- 11완료일 -->',
    t += '\t<col class="mdate" style="width:4%" /><!-- 12수정일 -->',
    t += '\t<col class="cdate" style="width:4%" /><!-- 13확인일 -->',
    t += '\t<col class="etc" style="width:auto" /><!-- 14기타 -->',
    t += "</colgroup>",
    t += "<thead>",
    t += "\t<tr>",
    t += '\t\t<th scope="col" class="num">번호</th><!-- 1번호 -->',
    t += '\t\t<th scope="col" class="depth2">2Depth</th><!-- 2Depth -->',
    t += '\t\t<th scope="col" class="depth3">3Depth</th><!-- 3Depth -->',
    t += '\t\t<th scope="col" class="depth4">4Depth</th><!-- 4Depth -->',
    t += '\t\t<th scope="col" class="pid">메뉴명</th><!-- 5메뉴명 -->', 
    t += '\t\t<th scope="col" class="page">화면ID</th><!-- 6화면ID -->',
    t += '\t\t<th scope="col" class="path">경로</th><!-- 7경로 -->',
    t += '\t\t<th scope="col" class="kind">구분</th><!-- 8구분 -->',
    t += '\t\t<th scope="col" class="coder coder1">퍼블리셔</th><!-- 9퍼블리셔 -->',
    t += '\t\t<th scope="col" class="coder coder2">개발자</th><!-- 10개발자 -->',
    t += '\t\t<th scope="col" class="rdate">완료일</th><!-- 11완료일 -->',
    t += '\t\t<th scope="col" class="mdate">수정일</th><!-- 12수정일 -->',
    t += '\t\t<th scope="col" class="cdate">확인일</th><!-- 13확인일 -->',
    t += '\t\t<th scope="col" class="etc">기타</th><!-- 14기타 -->',
    t += "\t</tr>",
    t += "</thead>",
    document.write(t)
}
...
$(document).ready(function() {
    (function() {
        ...
        Util.getDirName())
          ...
          , o = t.tab_navList.size() - 2 //화면 로딩 후 탭 위치
              ...
              , c = function() {
                t.tab_content.find("tr").each(function(t) {
                    var e = $(this).find(".num a")
                      , o = $(this).find(".pid").text() + '(' + $(this).find(".page").text() + ')'
