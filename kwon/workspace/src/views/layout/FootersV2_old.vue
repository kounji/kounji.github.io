<template>
	<div class="custom_footer mydata2023">
		<!-- footer -->
		<div id="com_footer" class="renewal mainFooter block"><!-- // 하단 고정 -->
			<div class="footer-cancle">
				<button class="cancle"><span class="blind">푸터메뉴닫기</span></button>
			</div>
			<!-- <mama2009 ref="mama2009" v-if="mktBannerYN === 'Y' && bannerList.length > 0"></mama2009> -->
			<div class="footer-depth1">
				<ul>
					<li class="item1" :class="{active:isActiveTab('as')}">
		...
		<!-- //footer -->
		<!-- 전체메뉴 -->
		<!-- <mrmr1001 @closeAllMenuMRMR2001="callAllMenuCloseMRMR2001" ref="mrmr1001"></mrmr1001> -->
	</div>
</template>
