<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > NH지역정보 > 슬기로운영농생활 > 손익분석 > 손익분석 메인 
* @ 페이지설명 : 손익분석 메인 
* @ 파일명     : src/views/page/SZ/FP/SZFP4101/SZFP4101.vue
* @ 작성자     : CS523299
* @ 작성일     : 2021-08-12
************************** 수정이력 ****************************************
* 날짜                    작업자                변경내용
...
* 2025-03-04              CS540683              상호금융 NH콕마이데이터 4.0 추진 개발 SZFP2101 → SZFP4101 
*************************************************************************/
-->
<template>
	<!-- kimhc_20220922 수정-->
    ...
    <page class="content-view hasLNB">
		...
		-->
		<an-sub-category-v4 type="FP"></an-sub-category-v4>
        <!-- E :: 마이농가 카테고리 -->
			<!-- content-view S -->
