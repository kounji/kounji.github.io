<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > NH지역정보 > 슬기로운영농생활  > 마이농가설정
* @ 페이지설명 : 마이농가설정
* @ 파일명     : src/views/page/SZ/ST/SZST4101/SZST4101.vue
* @ 작성자     : CS515729
* @ 작성일     : 2021-05-21
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-03-04              CS540683              상호금융 NH콕마이데이터 4.0 추진 개발 SZST2101 → SZST4101 
*************************************************************************/
-->
...
<template>
    ...
    <page class="content-view hasLNB">
        ...
        -->
        <an-sub-category-v4 type="ST"></an-sub-category-v4>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fn_onLoadInit(){
                console.log("[SZST4101]fn_onLoadInit()/여기인가여???/~~~ ")
