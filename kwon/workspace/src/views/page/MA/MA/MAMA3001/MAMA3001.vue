    ...
    <div class="content-view">
        <div id="content">
            <section class="main_united">
                <!-- [배너] -->
                <p class="top_banner ty01">
                    <a href="#nolink">새로워진 NH콕마이데이터 이용안내</a>
                ...
                <div class="info">
                    ...
                    <a href="javascript:void(0);" class="char_set" @click="fn_moveOpenPage('MAMA4004')"> <!--[v4.0] 2025-03-17 a구조로 변경 -->
                        <lottie-animation v-if="myCharId == 'char_rdo_01'" :animationData="require('@/assets_v40/images/lottie/icon_united_mento.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation>
                        <lottie-animation v-else-if="myCharId == 'char_rdo_02'" :animationData="require('@/assets_v40/images/lottie/icon_united_swell.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_03'" :animationData="require('@/assets_v40/images/lottie/icon_united_savings_king.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_04'" :animationData="require('@/assets_v40/images/lottie/icon_united_investment_genius.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_05'" :animationData="require('@/assets_v40/images/lottie/icon_united_saving_master.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_06'" :animationData="require('@/assets_v40/images/lottie/icon_united_insurance_guardian.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_08'" :animationData="require('@/assets_v40/images/lottie/icon_united_credit_keeper.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else-if="myCharId == 'char_rdo_09'" :animationData="require('@/assets_v40/images/lottie/icon_united_loan_coach.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation> 
                        <lottie-animation v-else :animationData="require('@/assets_v40/images/lottie/icon_united_mento.json')" ref="anim"  :loop="true" :auto-play="true"  :speed="1" aria-hidden="true" class="icon_united_me" ></lottie-animation>

                        <!--
                        <lottie-animation v-show="myCharId=='char_rdo_01'" :animationData="require('@/assets_v40/images/lottie/icon_united_mento.json')" 
                                        ref="anim"
                                        :loop="true"
                                        :auto-play="true" 
                                        :speed="1"
                                        aria-hidden="true" 
                                        class="icon_united_me" 
                                        >
                        </lottie-animation> 
                        <lottie-animation v-show="myCharId=='char_rdo_02'" :animationData="require('@/assets_v40/images/lottie/icon_united_swell.json')" 
                                        ref="anim"
                                        :loop="true"
                                        :auto-play="true" 
                                        :speed="1"
                ...
                <div class="finance_sheet" >
                    ...
                    <details>
                        <summary>
                            <!-- case1 증가 -->
                            <div v-if="astIndSum > 0" class="head">
                            ...
                            <!-- case2 감소 -->
                            <div v-else-if="astIndSum < 0" class="head">
                        ...
                        <div class="cont">
                            ...
                            <a href="#nolink" class="sum_select">{{ totAsetAm | numberFilter }}<span>원</span></a>
                            <div class="tooltip">
                                <p class="latter up" v-if="astIndSum > 0">지난달보다 <span class="num">{{ astIndSum | numberFilter }}원</span> <em>늘었어요.</em></p>
                                <p class="latter latter down" v-else-if="astIndSum < 0">지난달보다 <span class="num">{{ astIndSum | numberFilter }}원</span> <em>줄었어요.</em></p>
                ...
                <template v-for="tab in tabs" >
					...
					<div class="stock_sheet" v-if="tab.id === 'item01'" :key="tab.id">
						<div class="slick_exchange">
							<div class="inner">
								<dl class="exchange">
									<dt>KOSPI</dt>
									<dd class="factor">
										<span class="num">2,620.01</span>
										<span class="range up">8.64%(전일대비)</span>
									</dd>
									<dd class="basis">
										<span>2025.02.04</span>
										<span>15:.00:00 기준</span>
									</dd>
								</dl>
								<dl class="exchange">
									<dt>KOSDAQ</dt>
								...
								<dl class="exchange">
									<dt>
										...
										<i class="ico ico_USD"></i>
										미국 USD
									</dt>
									<dd class="factor">
										<span class="unit">KRW</span>
										<span class="num">727.26</span>
										<span class="range">0.00(전일대비)</span>
									</dd>
									<dd class="basis">
										<span>2025.02.04</span>
										<span>15:.00:00 기준</span>
                        ...
                        <ul class="asset_list">
                            ...
                            <li v-if="menu04Able == 'Y'" class="menu04">
                                <a href="javascript:void(0);" class="head" @click="fn_movePage('ASPS4001')">
                                    <strong>투자<span class="num">{{ asetFnPnsTtcn | numberFilter }}</span></strong>
                                    <span class="txt"></span>
                                </a>
                            ...
                            <li v-if="menu07Able == 'Y'" class="menu07">
                                <a href="javascript:void(0);" class="head" @click="fn_movePage('ASCD2001')">
                    ...
                    <div class="connect_sheet" v-if="tab.id === 'item07'" :key="tab.id">
                        ...
                        <div class="board_box">
                            <p class="txt"><strong>총 {{orgConCnt}}개</strong> 기관에 연결되었습니다.</p>
                            <ul class="organ_list">
                                <li>
                                    <div class="tit_area">
                ...
                <div class="setting">
                    ...
                    <button type="button">자산연결</button>
                </div>

                <!-- [플로팅 배너] --> <!--[v4.0] 2025-03-17 플로팅 배너 추가 -->
                <div v-if="floatYn=='Y'" class="float_link">
                    <div class="float" aria-label="플로팅 배너">
                        ...
                        <!--<lottie-player src="@/assets_v40/images/lottie/icon_float_char.json" loop autoplay aria-hidden="true" class="icon_float"></lottie-player>-->
                    </div>
                    <ul class="list">
                        <li><a href="#nolink">1만을 축하해! 이벤트 도착</a></li>
                        <li><a href="#nolink">10만을 축하해! 이벤트 도착</a></li>
                        <li><a href="#nolink">100만을 축하해! 이벤트 도착</a></li>
                        <li><a href="#nolink">1000만을 축하해! 이벤트 도착</a></li>
                    </ul>
                    <button type="button" class="close" id="check_float" @click="fn_setFloatBannerYn()" aria-label="플로팅 배너 삭제"></button>
                </div>                
            </section>
        </div>
...
import ASAC4001 from '@/views/page/AS/AC/ASAC4001/ASAC4001' // v4 예금
import ASRE4001 from '@/views/page/AS/RE/ASRE4001/ASRE4001' // v4 부동산
import ASIV4001 from '@/views/page/AS/IV/ASIV4001/ASIV4001' // v4 투자
import ASPS4001 from '@/views/page/AS/PS/ASPS4001/ASPS4001' // v4 연금
import ASPT4001 from '@/views/page/AS/PT/ASPT4001/ASPT4001' // v4 페이/포인트
import ASIS4001 from '@/views/page/AS/IS/ASIS4001/ASIS4001' // v4 보험
import ASCD2001 from '@/views/page/AS/CD/ASCD2001/ASCD2001' // v4 카드
import ASLN4001 from '@/views/page/AS/LN/ASLN4001/ASLN4001' // v4 대출
import ASCA4001 from '@/views/page/AS/CA/ASCA4001/ASCA4001' // v4 자동차
import ASOA4001 from '@/views/page/AS/OA/ASOA4001/ASOA4001' // v4 기타자산
import ASIT4001 from '@/views/page/AS/IT/ASIT4001/ASIT4001' // v4 할부금융
import ASCL4001 from '@/views/page/AS/CL/ASCL4001/ASCL4001' // v4 자동차할부
import ASEL4001 from '@/views/page/AS/EL/ASEL4001/ASEL4001' // v4 학자금대출
import ASLS4001 from '@/views/page/AS/LS/ASLS4001/ASLS4001' // v4 리스
import ASBR4001 from '@/views/page/AS/BR/ASBR4001/ASBR4001' // v4 빌린돈
...
export default {
    ...
    methods : {
        ...
        initComponent() {
            ...
            // 나의 캐릭터
            let tmpMyCharId = commonService.getStorage('main' + this.getUserInfo('chnl') + this.getUserInfo('mydtCusno') + 'myChar') 
            
			console.log("initComponent : tmpMyCharId =================>", this.tmpMyCharId)
			if (tmpMyCharId !== undefined) {
				this.myCharId = tmpMyCharId
			} else  {
				this.myCharId = 'char_rdo_01'
			}
			console.log("initComponent : myCharId =================>", this.myCharId)
        ...
        getMyCharPath() {
            let path = '';
            switch(this.myCharId) {
                case 'char_rdo_01': // 금융멘토 : icon_united_mento.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_mento.json"
                    break
                case 'char_rdo_02': // 디지털금융달인 : icon_united_swell.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_swell.json"
                    break
                case 'char_rdo_03': // 저축왕 icon_united_savings_king.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_savings_king.json"
                    break
                case 'char_rdo_04': // 투자천재 icon_united_investment_genius.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_investment_genius.json" 
                    break
                case 'char_rdo_05': // 절약마스터 icon_united_saving_master.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_saving_master.json"
                    break
                case 'char_rdo_06': // 보험수호자 icon_united_insurance_guardian.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_insurance_guardian.json"
                    break
                case 'char_rdo_08': // 신용지킴이 icon_united_credit_keeper.json
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_credit_keeper.json"
                    break
                case 'char_rdo_09': // 대출코치 icon_united_loan_coach.json    
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_loan_coach.json"
                    break 
                default :
                    this.myCharPath = "@/assets_v40/images/lottie/icon_united_mento.json"
                    break                                                                                                
        ...
        getData(mainFlag) {
            ...
            Promise.all([
                ...
                //this.fn_getNewMainData(mainFlag),
                // 2.자산진단 : 나의재무진단 
                ...
                this.fn_getCardPayInfo(),       // v4 삭제 : 카드결제 예정 정보 조회 - 2023.07.19 by CS533461
                this.fn_getGoalData(),          // v4 삭제 : 나의목표 조회
                this.fn_getXpsData(),           // v4 삭제 : 지출 정보 조회                
        ...
        fn_getMainData(mainFlag) {
            ...
            apiService.call(config).then(response =>{
                ...
                this.astIndSum  = 0
                this.astIndSum += this.indAsetFnAcAmSum
...
console.log("fn_getInteList.................response", response)                
            ...
            modalService.openPopup(config).then((response) => {
                ...
                if(pageId === "PDMY2005" || pageId === "PDMY2033") {
                    ...
                    if (response === 'reSelect') {
                        setTimeout(() => this.fn_getGoalData(), 10)
                    }
                }
		...
		slick () {
			...
			// 자산분석을 통한 제안
			$('.main_united .suggest_sheet').each(function(){
				let $this = $(this);
			...
			// 건강, 연금/절세
			$('.main_united .health_sheet').each(function(){
				let $this = $(this);
			...
			// 주가지수
			$('.main_united .slick_exchange').each(function(){
				let $this = $(this);
        ...
        */
        ...
        fn_ixSatRate(dgnRzt, ixSatC) {
            ...
            */  
            ...
            console.log("fn_ixSatRate : dgnRzt : ", dgnRzt)
            console.log("fn_ixSatRate : ixSatC : ", ixSatC)
            console.log("fn_ixSatRate : ixSatRate : ", ixSatRate)
            return ixSatRate
        },
