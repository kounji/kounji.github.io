<!--
/*************************************************************************
* @ 서비스경로 : 지출분석 > 지출현황 > 선불카드
* @ 페이지설명 : 지출분석 > 지출현황 > 선불카드 지출내역 슬라이드 팝업
* @ 파일명     : src/views/page/LC/LE/LCLE2119/LCLE2119.vue
* @ 작성자     : CS515937
* @ 작성일     : 2021-10-13
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2021-10-13              CS515937              최초작성
* 2023-09-05              CS533571              마이데이터 확대개발 화면ID 변경(기존 LCLE1119)
*************************************************************************/
-->
<template>
    <div>
