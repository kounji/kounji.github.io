...
/*************************************************************************
* @ 서비스경로 : 연금절세 > 연말정산공제금액
* @ 페이지설명 : 연금절세 > 연말정산공제금액 > 카드 소득공제
* @ 파일명     : src\views\page\PD\YT\PDYT4104\PDYT4104.vue
* @ 작성자     : CS533541
* @ 작성일     : 2023-07-20
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2023-07-20              CS533541              최초작성(PDYT1104.vue -> PDYT2104.vue )
* 2025-03-26              CS541015              상호금융 NH콕마이데이터 4.0 추진 개발(PDYT2104.vue -> PDYT4104.vue)
*************************************************************************/
-->
<template>
