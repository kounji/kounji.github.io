...
* @ 파일명     : src\views\page\PD\YT\PDYT1001\PDYT1001.vue
* @ 작성자     : CS515897
* @ 작성일     : 2021-08-25
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2022-08-16              CS528061              고도화 및 파일명 변경(PDYT1102 -> PDYT1001)
*************************************************************************/
-->
<template>
    <div>
            ...
            <div aria-hidden="false" class="slide_popup" id="slide_popup_01" style="display: block;">
                ...
                <div class="popup_content com_btn_bottom">
                    <div class="com_input_type01 com_word2">
                        <input type="tel" id="txt01" :class="totSalAm.length > 0?'focusON focusforce':''" required="" maxlength="7" placeholder="총 소득 입력하세요" title="총 소득 입력"
                        ...
                        <p class="com_txtinfo_type01">총소득에 따라 공제 여부와 금액이 다릅니다.</p>
                    </div>
                </div>
                <div class="popup_footer">
                    <div class="btn_full_box2">
                        <a href="javascript:void(0);" class="btn btn_mint" :class="btnOnOff" @click.prevent="fn_openModalPDYT1103($event)">확인</a>
                    </div>
                </div>
...
import PDYT1103 from '@/views/page/PD/YT/PDYT1103/PDYT1103'
