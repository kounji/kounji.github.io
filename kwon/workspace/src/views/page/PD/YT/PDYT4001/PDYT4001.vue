...
/*************************************************************************
* @ 서비스경로 : 연금절세 > 연말정산공제금액
* @ 페이지설명 : 연금절세 > 연말정산공제금액 > 나의 연말정산 공제결과
* @ 파일명     : src\views\page\PD\YT\PDYT4001\PDYT4001.vue
* @ 작성자     : CS533541
* @ 작성일     : 2023-07-25
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-03-26              CS541015				상호금융 NH콕마이데이터 4.0 추진 개발 (PDYT2001 → PDYT4001)
*************************************************************************/
-->
<template>
		...
		<div class="popup_content com_no_bottom yearend_tax" v-if="!isAllNotExist">
			...
			<div class="com_inner" v-if="isNotTotAmt">
				<ul class="layoutBox topTit pt0">
					...
					<li class="right">
						<button type="button" class="stdBtn innerType01"> <a href="javascript:void(0);"  @click.prevent="fn_openCOAR4001()">자산등록</a></button>
					</li>
				</ul>
			</div>
			<!-- //공제금액이 모두없는경우 -->
			...
			<div class="com_inner">
				...
				<template v-else>
					...
					<div class="line_box_2023 plus_type">
						<a href="javascript:void(0);" class="btn_round_plus" @click.prevent="fn_openCOAR4001()">
							<div class="title_area">
								<span class="badge_2023 green_badge02">카드 소득공제</span>
		...
		<div class="com_bg_type02 popup_content" v-else>
			...
			<div class="bottom_box com_bg_type02">
				<div class="btn_full_box">
					<a href="javascript:void(0);" class="btn btn_mint" @click.prevent="fn_openCOAR4001()">자산 등록하기</a>
				</div>
			</div>
		</div>
		<!-- //연결된 자산이 없는경우 -->
