...
* @ 파일명     : src\views\page\PD\PD\PDPD1105\PDPD1105.vue
* @ 작성자     : CS516033
* @ 작성일     : 2021-08-23
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2021-08-23              CS516033              최초작성
    ...
    <div class="full_popup renewal" id="full_popup_01"> 
		...
		<div class="popup_content"><!-- 하단 버튼 없을때 com_no_bottom -->
			<div class="com_inner">
				...
				<div class="steps mt20">
					<ol role="img" aria-label="총 3단계 중 2단계">
						<li></li>
						<li class="on">2</li>
						<li></li>
					</ol>
				</div>
				<div class="com_box_type01 mt15 steps_top2">
					<strong class="com_box_tit">필요 자금</strong>
				</div>
				<!--// step -->
				<!-- 은퇴 후 월 생활비 -->
				...
				<!--// 연간 의료비 -->
				<strong class="com_box_tit mt50" v-show="nextStepYn">기타 필요 자금</strong>
				<!-- 연간 자녀교육 비용 -->
				<div class="com_input_type01 com_word2 custom_box" v-show="nextStepYn">
		...
		<div class="popup_footer fixed">
			<div class="com_btnhalfbox_type02">
				<a href="javascript:void(0);" class="btn btn_grey" role="button" @click.prevent="close()">이전</a>
...
<script>
    ...
    import PDRT1007 from '@/views/page/PD/RT/PDRT1007/PDRT1007' // 월생활비
    import PDRT1008 from '@/views/page/PD/RT/PDRT1008/PDRT1008' // 연의료비
    ...
    export default {
        ...
        methods: {
            ...
            fn_nextStep() {
                /*
                if(this.chdrEduAm == null || this.chdrEduAm == '') {
                    this.chdrEduAm = 0
                }
                if(this.chdrWeddAm == null || this.chdrWeddAm == '') {
                    this.chdrWeddAm = 0
                }
                if(this.etcYyAm == null || this.etcYyAm == '') {
                    this.etcYyAm = 0
                }
                */
