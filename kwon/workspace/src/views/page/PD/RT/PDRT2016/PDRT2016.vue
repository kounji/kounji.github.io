...
* @ 파일명     : src\views\page\PD\RT\PDRT2016\PDRT2016.vue
* @ 작성자     : CS533541
* @ 작성일     : 2023-07-18
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2023-07-18              CS533541              최초작성(PDPD1110.vue -> PDRT2016.vue )
*************************************************************************/
-->
<template>
            ...
            getChart() {
                ...
                var layoutStr =
                                '<rMateChart backgroundColor="transparent" borderStyle="none">'
                                    +'<Pie2DChart innerRadius="0.6" showDataTips="false" selectionMode="single">'
                                /*
