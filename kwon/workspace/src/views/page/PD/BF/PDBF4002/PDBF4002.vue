...
* @ 페이지설명 : 연금절세 > 데일리 금융브리핑 > 환율알림설정
* @ 파일명     : src\views\page\PD\BF\PDBF4002\PDBF4002.vue
* @ 작성자     : CS528061
* @ 작성일     : 2022-10-05
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-02-13              CS541015              고도화 파일명, UI 변경 및 고도화 개발(PDBF2002.vue -> PDBF4002.vue)
*************************************************************************/
-->
<template>
    <!-- full popup S -->
						...
						<div class="item">
							...
							<div class="custom_country_list_box01">
								<div class="com_box_type01" v-for="(item, idx) in myCurList" :key="idx">
                                    ...
                                    <!--[v4.0] 알림설정 버튼 추가-->
									<button type="button" class="custom_box_btn" @click.prevent="fn_openSlidePopup(item)">알림설정</button>
									<!--//[v4.0] 알림설정 버튼 추가-->
								</div>
							</div>
						</div>
