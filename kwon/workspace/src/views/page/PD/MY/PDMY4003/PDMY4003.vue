<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 나의목표 > 나의목표 만들기
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 나의목표 > 나의목표 만들기
* @ 파일명     : src\views\page\PD\MY\PDMY4003\PDMY4003.vue
* @ 작성자     : CS533453
* @ 작성일     : 2023-07-17
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-01-20              CS541015              고도화 파일명, 연결화면 변경(PDMY2003.vue -> PDMY4003.vue)
*************************************************************************/
-->
