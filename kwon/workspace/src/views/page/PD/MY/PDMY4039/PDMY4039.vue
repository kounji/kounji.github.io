<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 금융목표 > 돈모으기
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 금융목표 > 돈모으기 > 돈모으기 상세
* @ 파일명     : src/views/page/PD/MY/PDMY2039/PDMY2039.vue
* @ 작성자     : CS516029
* @ 작성일     : 2021-08-10
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2023-08-04              CS533453              고도화 파일명 변경(PDMY1109.vue -> PDMY2039.vue)
* 2025-02-04              CS541015              고도화 파일명, 연결화면 변경(PDMY2039.vue -> PDMY4039.vue)
*************************************************************************/
-->
<template>
    <div class="full_popup" id="full_popup_01">
        ...
        <div class="popup_content com_bg_type00">
			<div class="new_goal_box new_goal_box_detail goal_done">
				<div class="head_wrap">
					<div class="head">
						<p><span class="icon save_ico"></span>{{obtnm}}</p>
					</div>
			...
			getData() {
				...
				apiService.call(config).then(response => {
                    ...
                    if(typeof this.fncObtAm == "undefined" || this.fncObtAm == 0) {
                        ...
                        this.setProgressBar = {'width':this.obtPer + '%'}
                    }
				});
			},
			// 목표삭제
