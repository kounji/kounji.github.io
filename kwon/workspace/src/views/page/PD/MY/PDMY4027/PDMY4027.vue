<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 자기계발 상세
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 자기계발 상세
* @ 파일명     : src\views\page\PD\MY\PDMY4027\PDMY4027.vue
* @ 작성자     : CS533453
* @ 작성일     : 2023-07-17
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2024-01-24              CS541015              고도화 파일명, 연결화면 변경(PDMY2027.vue -> PDMY4027.vue)
*************************************************************************/
-->
		...
		<div class="popup_content com_bg_type00"><!-- 하단 버튼 없을때 com_no_bottom -->
			<div class="com_inner" :class="goalCheck">
				<div class="mygoal_title_area">
					<p class="pointColor green">새로운 도전, 자기계발로 시작!</p>
					<strong class="titH1">{{obtnm}}</strong>
					<p class="sub_text">{{slfImprvmntCstRkonDscNm1}}<span class="dot_text">{{slfImprvmntCstRkonDscNm2}}</span></p>
				</div>
