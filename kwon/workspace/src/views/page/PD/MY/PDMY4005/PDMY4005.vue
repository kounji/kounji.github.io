...
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 버킷리스트
* @ 파일명     : src/views/page/PD/MY/PDMY4005/PDMY4005.vue
* @ 작성자     : CS516029
* @ 작성일     : 2021-05-27
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-01-10              CS541015              고도화 파일명, UI 변경 및 고도화 개발(PDMY2005.vue -> PDMY4005.vue)
*************************************************************************/
-->
<template>
    <!-- full popup S -->
					...
					<ul class="list_link_type">
						<li>
							<a href="javascript:void(0);" class="spare" @click.prevent="firstStepPop('00')">
								<p>예산만큼 아껴쓰기</p>
								<template v-if="xpsAm !== null && xpsAm !== undefined && xpsAm > 0">
    ...
    export default {
        ...
        methods: {
			...
			firstStepPop(gubn) {
				...
				if(gubn == '00') {
					if(this.xpsAm !== null && this.xpsAm !== undefined && this.xpsAm > 0) {
