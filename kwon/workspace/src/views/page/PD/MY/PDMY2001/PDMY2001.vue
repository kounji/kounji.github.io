...
* @ 서비스경로 : 금융과생활 > 나의목표
* @ 페이지설명 : 금융과생활 > 나의목표 > 목록
* @ 파일명     : src\views\page\PD\MY\PDMY2001\PDMY2001.vue
* @ 작성자     : CS515731
* @ 작성일     : 2021-05-14
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
<template>
    <page class="content-view mydata2023" :class="bckCnt == 0 && finCnt == 0 && acnoObtCnt == 0 ? '' : 'movLNB '">
        <pd-category-v2 ref="pdCate" type="PDMY"></pd-category-v2>

        <div class="lnb_box" v-if="bckCnt > 0 || finCnt > 0 || acnoObtCnt > 0">
            <div class="choice_wrap">
                <div class="choice_option">
                    <button type="button" :title="this.tabDsc == 0 ? '선택됨' : '선택안됨'" :class="this.tabDsc == 0 ? 'active' : ''" @click="onTabClick(0)">버킷리스트 <em class="num">{{this.bckCnt}}</em></button>
                    <button type="button" :title="this.tabDsc == 1 ? '선택됨' : '선택안됨'" :class="this.tabDsc == 1 ? 'active' : ''" @click="onTabClick(1)">금융목표 <em class="num">{{this.finCnt}}</em></button>
                </div>
            </div>
        </div>
            ...
            <template v-if="bckCnt > 0 || finCnt > 0 || acnoObtCnt > 0">
                <div class="com_inner">
                    <div class="box_border_link iconType01 mt20" v-if="acnoObtCnt > 0">
                        <a role="button" href="javascript:void(0);" @click="openAcountListPop()"><span class="arrow"><em class="num">{{this.acnoObtCnt}}</em>개의 목표에 계좌 연결이 필요해요</span></a>
                    </div>
                </div>
				...
				<div class="goal_box_wrap com_inner">
                    ...
                    <template v-for="(financialInfo, index) in financialList">
                        ...
                        <template v-else>
                            ...
                            <div class="mygoal_cont_box bucketList" :class="financialInfo.divColor" :key="'key2_'+index" @click="detailMove2(financialInfo.fncObtDsc, financialInfo.sqno, financialInfo.prgStsCd, financialInfo.carGrdNo, financialInfo.carCtrimNo, financialInfo.basyy, financialInfo.basmm)" name="finance">
                                <a href="javascript:void(0);">
                                    <div class="head">
                                    ...
                                    <div class="bucketList_save_money">
                                        ...
                                        <div class="progressBar_wrapper" role="img" :aria-label="'목표 금액대비 '+financialInfo.obtRate+'% 달성'">
                                            ...
                                            <!-- <div class="progressBar">
                                                <div class="bar">
                                                    <em class="blind">{{financialInfo.obtRate}}</em>
                                                </div>
                                            </div> -->
                                        </div>
                                    </div>
