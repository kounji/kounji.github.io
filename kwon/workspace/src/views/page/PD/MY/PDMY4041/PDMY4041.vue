<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 금융목표 > 투자목표
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 금융목표 > 투자목표 > 투자목표 상세
* @ 파일명     : src/views/page/PD/MY/PDMY4041/PDMY4041.vue
* @ 작성자     : CS516029
* @ 작성일     : 2021-08-10
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-02-04              CS541015              고도화 파일명, 연결화면 변경(PDMY2041.vue -> PDMY4041.vue)
*************************************************************************/
-->
<template>
