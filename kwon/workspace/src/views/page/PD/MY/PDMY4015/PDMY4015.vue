<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 자기계발 목표
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 자기계발 목표 > 자기계발 목표 저장
* @ 파일명     : src\views\page\PD\MY\PDMY4015\PDMY4015.vue
* @ 작성자     : CS533453
* @ 작성일     : 2023-07-17
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-01-13              CS541015              고도화 파일명, UI변경 및 고도화개발(PDMY2015.vue -> PDMY4015.vue)
*************************************************************************/
-->
