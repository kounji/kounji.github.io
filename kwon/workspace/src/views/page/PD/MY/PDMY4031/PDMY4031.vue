<!--
/*************************************************************************
* @ 서비스경로 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 여행목표 상세
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 여행목표 상세
* @ 파일명     : src/views/page/PD/MY/PDMY4031/PDMY4031.vue
* @ 작성자     : CS516029
* @ 작성일     : 2021-08-23
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-01-24              CS541015                 고도화 파일명, 연결화면 변경(PDMY2031.vue -> PDMY4031.vue)
*************************************************************************/
-->
