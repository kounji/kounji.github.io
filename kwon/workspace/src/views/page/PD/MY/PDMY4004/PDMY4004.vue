...
* @ 페이지설명 : 전체메뉴 > 도전목표챌린지 > 버킷리스트 > 버킷리스트 계좌 연결
* @ 파일명     : src\views\page\PD\MY\PDMY4004\PDMY4004.vue
* @ 작성자     : CS533453
* @ 작성일     : 2023-07-17
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-01-20              CS541015              고도화 파일명, 연결화면 변경(PDMY4004.vue -> PDMY4004.vue)
*************************************************************************/
-->
...
<template>
	...
	<div class="full_popup mydata2023" id="full_popup_01"> 
		<div class="popup_header">    
			<!--[v4.0] 타이틀 수정--> 
			<h1>{{this.pageTit}} 계좌 연결</h1>
            <!--//[v4.0] 타이틀 수정--> 
		</div>	
		<div class="popup_content com_space_bottom com_bg_type00">
			<div class="com_inner">
				<strong class="titH1">계좌를 연결하고 목표관리하세요.</strong>
...
export default {
    ...
    methods: {
        ...
        initComponent(params) {
            ...
            this.pageTit = params.pageTit;
            this.pageGubun = params.pageGubun;
        },
        getData() {
