<!--
/*************************************************************************
* @ 서비스경로 : 자산>부채관리>대출목록>신용대출>신용대출 상세조회
* @ 페이지설명 : 자산>부채관리>대출목록>신용대출>신용대출 상세조회
* @ 파일명     : src/views/page/AS/LN/ASLN4004/ASLN4004.vue
* @ 작성자     : 
* @ 작성일     : 2023-07-10
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2025-02-13              CS541017              ASLN2004 - > ASLN4004 고도화 4.0변경
*************************************************************************/
-->
<template>
    <!-- full popup S -->
	<div class="full_popup mydata2023" id="full_popup_01"> 
		...
		<div class="popup_content com_space_bottom com_bg_type00">
			...
			<div class="com_inner">
					<a href="javascript:void(0);" role="button" @click="showMoreList()" class="com_btn_more" v-show="lsPageYn==='1'">더보기</a>
			</div>
		</div>
