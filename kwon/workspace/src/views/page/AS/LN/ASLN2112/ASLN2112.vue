...
/*************************************************************************
* @ 서비스경로 : 나의자산 > 부채 > 할부금융
* @ 페이지설명 : 나의자산 > 부채 > 할부금융 상세
* @ 파일명     : src/views/page/AS/LN/ASLN2112/ASLN2112.vue
* @ 작성자     : CS515937
* @ 작성일     : 2021-05-31
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2021-05-31              CS515937               최초작성
* 2023-09-19              CS533031         As-Is → To-Be Css 변경
*************************************************************************/
-->
<template>
    <div class="full_popup mydata2023"><!-- mydata2023 추가 -->
