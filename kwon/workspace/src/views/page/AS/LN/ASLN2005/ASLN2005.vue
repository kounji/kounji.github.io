<!--
/*************************************************************************
* @ 서비스경로 : 나의자산 > 부채 > 대출 > 신용대출
* @ 페이지설명 : 나의자산 > 부채 > 대출 > 신용대출 상세
* @ 파일명     : src/views/page/AS/LN/ASLN2005/ASLN2005.vue
* @ 작성자     : CS515937
* @ 작성일     : 2021-05-13
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2023-07-10              CS533437              ASLN1108 -> ASLN2005
					...
					<div class="top_info_box type02 new_top_box fixBG hasdetail">
						<div class="box_head">
							<div class="info">
                                ...
                                <!-- 보험대출 -->
                                <div class="title" v-if="loanType == 'CREDIT_INSU'">
                                    {{isrcoLnWrsnm}}
                        ...
                        <div class="text" v-if="loanType != 'CREDIT_INSU'">대출금리 <em>{{aplItr | numberFilter('0,0.00', {precision: 2})}}%</em></div>
                        <div class="bill">
                                    ...
                                    <div data-ui-toggle="box">
                                        <div class="view-box">
                                            ...
                                            <template v-if="(auttrOrgCNm != '' && auttrRpyAcno != '') && (auttrOrgCNm != null && auttrRpyAcno != null)">
                                                <div class="info" v-if="loanType != 'CREDIT_INSU'">
                ...
                <ul class="list_type_02 list_subtype02">
                    <li v-for="(item, index) in bankInsuLoanAccountTransactionListOut" :key="index">
                        ...
                        <div class="listbox_area">
                            <!-- <div class="listbox_type01" v-for="intList in item.bankInsuLoanAccountTransactionIntSubOut" :key="fn_loanType?intList.trIntBrkSqno:intList.intAplSqno"> -->
...
export default {
    ...
    data: () => {
        return {
            ...
            bankInsuLoanAccountTransactionListOut : [], // 은행대출계좌거래내역Out
    ...
    computed : {
        ...
        fn_loanType() {
            return (this.loanType == 'CREDIT_INSU')?true:false
        },
        fn_rpyMethod() {
    ...
    methods: {
        ...
        getData() {
            ...
            apiService.call(config).then(response => {
                ...
                this.getTransaction()   // 신용대출 거래내역 조회
            });
        },
