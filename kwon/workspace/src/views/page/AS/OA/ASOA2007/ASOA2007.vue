            ...
            <div aria-hidden="false" class="slide_popup" id="slide_popup_01" style="display: block;">
                ...
                <div class="popup_content">
                    <div class="custom_check_list">
                        <div class="tab_radio">
                            <div class="btn_radio">
                                <input type="radio" name="radio01" id="radio1-1" checked  v-on:click="changeMprType(0)">
                                <label for="radio1-1">
                                    <span>내가 살 때</span>
                                </label>
                            </div>
                            <div class="btn_radio">
                                <input type="radio" name="radio01" id="radio1-2" v-on:click="changeMprType(1)">
                                <label for="radio1-2">
                                    <span>내가 팔 때</span><!-- 2022-07-15 문구수정 -->
                                </label>
                            </div>
                        </div>
                    ...
                    <p class="com_txtinfo_type01">VAT포함 가격이며 실제와 다를 수 있습니다.</p>
                </div>
...
export default {
    ...
    methods: {
        ...
        calculateVal(e="") {
            ...
            let unitPrice = this.selectedMprType == 0 ? this.selectedGoldMpr.goldPucMpr : this.selectedGoldMpr.goldSleMpr    // 살때시세 팔때시세
         ...
         * 골드 시세 타입 변경 (살때, 팔때)
         */
        changeMprType(mprType) {
            if (this.selectedMprType == mprType)
                return

            this.selectedMprType = mprType;
            this.calculateVal();
        },
        /**
         * 유닛 변경 (그램, 돈)
