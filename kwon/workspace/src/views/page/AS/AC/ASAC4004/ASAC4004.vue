...
/*************************************************************************
* @ 서비스경로 : 나의자산 > 자산현황 > 예금
* @ 페이지설명 : 나의자산 > 자산현황 > 예금 > 정렬 조건 팝업
* @ 파일명     : src/views/page/AS/AC/ASAC4004/ASAC4004.vue
* @ 작성자     : CS541017
* @ 작성일     : 2025-02-07
************************** 수정이력 ****************************************
* 날짜                    작업자                변경내용
*_________________________________________________________________________
* 2025-02-07              CS541017              최초작성
*************************************************************************/
-->
<template>
    <div>
                    ...
                    <div class="radio_list noLine">
                        ...
                        <template v-if="sortDs === '1'">
                            <div class="btn_radio">
                                ...
                                <label for="radio3-3">금리순</label>
                            </div>
                            <div class="btn_radio">
                                <input type="radio" name="radio03" id="radio3-4" v-model="sortVal" value="4" :checked="sortVal==='4'">
                                <label for="radio3-4">만기순</label>
                            </div>
                        </template>
...
export default {
    name : "ASLN4009",
     data: () => {
        return {
            sortVal    : "",   // 정렬 1 : 기본순 , 2 : 금액순 , 3 : 금리순 , 4 : 만기순
