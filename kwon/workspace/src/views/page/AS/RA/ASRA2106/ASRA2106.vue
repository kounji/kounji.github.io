...
* @ 서비스경로 : 나의자산 > 자산 > 기타
* @ 페이지설명 : 나의자산 > 자산 > 기타 현금
* @ 파일명     : src/views/page/AS/RA/ASRA2106/ASRA2106.vue
* @ 작성자     : CS516033
* @ 작성일     : 2021-05-27
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
                ...
                <div class="top_info_box_wrap mb30">
                    <div class="top_info_box type02 new_top_box fixBG">
                        <div class="box_head">
                            <div class="info">
                                <div class="title p-l">
                                    <i class="ico cash"></i>{{astnm}}
                                </div>
                            </div>
                        </div>
                        <div class="bill mt40 p-l">
                            <!-- <span class="text fs25"></span><span id="asetAm" class="num counter" :data-count="asetAm"></span><span class="text fs25">원</span> -->
                            <span class="text"></span><span id="asetAm" class="num counter">{{asetAm | numberFilter}}</span><span class="text fs22">원</span>
                        </div>
                        <div class="mt10 fs15 sub_txt p-l" v-html="memoCntn"></div>
                    </div>
                </div>
                <div>
                    <!--
                    <div class="new_float_popover_wrap">
                        <div class="float_popover m0">
                            <div class="text">
                                보유하신 현금을 <a href="javascript:void(0);"><span class="underline bold">NH정기예탁금</span></a>에 예치하시고<br/>이자 수익을 얻으세요.
                            </div>
    ...
    methods: {
        ...
        getData() {
            ...
            apiService.call(config).then(response => {
                ...
                this.memoCntn = this.memoCntn.replace(/\n/g, "<br>")
