...
* @ 파일명     : src/views/page/AS/RE/ASRE2001/ASRE2001.vue
* @ 작성자     : CS516033
* @ 작성일     : 2021-05-27
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2021-07-26              CS516033              2차개발
* 2022-08-02              CS528053              고도화 파일명, UI 변경 및 고도화 개발(ASRA1101.vue -> ASRE2001.vue)
* 2023-08-03              CS533049              콕마이테이터 3.0 고도화 적용
*************************************************************************/
-->
<template>
    <page class="content-view hasLNB mydata2023">
        ...
        <!-- S :: 자산 서브 카테고리 -->
        <as-sub-category-v2 type="RA1"></as-sub-category-v2>
        <!-- E :: 자산 서브 카테고리 -->
        <!--
        <div id="content" class="renewal" v-if="rlestList.length > 0">
        -->
        <div id="content" v-if="rlestList.length > 0">
