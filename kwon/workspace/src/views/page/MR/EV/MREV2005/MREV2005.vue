<!--
/*************************************************************************
* @ 서비스경로 : 이벤트 > 이벤트 개인정보 수집,이용동의 (이벤트 클릭시)
* @ 페이지설명 : 이벤트 개인정보 수집,이용동의
* @ 파일명     : src/views/page/MR/EV/MREV2005/MREV2005.vue
* @ 작성자     : CS530689
* @ 작성일     : 2024-02-14
************************** 수정이력 ****************************************
* 날짜                    작업자                변경내용
*_________________________________________________________________________
* 2024-02-14              CS530689              최초작성
*************************************************************************/
-->
<template>
    <!-- full popup S -->
		...
		<div class="popup_content"><!-- 하단 버튼 없을때 com_no_bottom -->
			<div class="com_inner">
					...
					<div class="event_tel">
						...
						<div class="custom_box custom_box6">						
							...
							<div class="com_input_type01 com_word1 ipt_tel_left">
								<input type="tel" id="com_input03" v-model="bckTelNo" value="" @input="fn_addPhoneNum($event)" required="" placeholder="‘-’없이 입력" title="휴대폰 번호를 입력하세요" maxlength="8"><div class="lineEF"></div>
				...
				<div class="enter_event_terms">
					...
					<div class="com_box_type01" v-html="refCntn">
					</div>
                    
						
						<!-- <strong class="terms_tit">개인정보 수집·이용 동의서 [필수]</strong>
						<strong class="terms_sub_tit dragon">[ 「2024년에도 NH콕마이데이터와 함께 해용 <span></span>」 대고객 이벤트 ]</strong>
						<div class="terms_txt">
							농업협동조합중앙회(이하 “농협중앙회” ) 귀중<br>
							농협중앙회와의 「2024년에도 NH콕마이데이터와 함께 해용」 대고객 이벤트(이하 “이벤트”라 합니다)와 관련하여 본회가 본인의 개인정보를 수집·이용하고자 하는 경우에는 「개인정보 보호법」 등 관계 법령에 따라 본인의 동의가 필요합니다.
						</div>
						<dl>
...
// import COFM1010 from '@/views/page/CO/FM/COFM1010/COFM1010'
// import COFM1020 from '@/views/page/CO/FM/COFM1020/COFM1020'
// import COFM1030 from '@/views/page/CO/FM/COFM1030/COFM1030'
...
export default {
    ...
    methods: {
        initComponent(param = {}) {
			...
			this.refCntn = param.refCntn

			//엔티티코드로 들어올경우 textarea에 넣어서 변환
			if(this.refCntn && this.refCntn.indexOf("&lt;") > -1){
				let refCntnHtml = document.createElement("textarea");
				refCntnHtml.innerHTML = this.refCntn
				this.refCntn = refCntnHtml.value
			}
		...
		fn_regEvent() {
			...
			this.close({'name' : this.name, 'telNo':this.frTelNo + this.bckTelNo, 'agreePersonalInfo' : this.agreePersonalInfo})
		}
