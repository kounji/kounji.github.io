        ...
        <div class="content-view">
            <div id="content">
                ...
                <section class="allNavi youth">
                    ...
                    <nav>
                        <ul>
                            <li id="navi01"><a href="javascript:void(0);" @click.prevent="fn_movePage('ASTA4C01')">나의 자산<span class="pin purple">NEW</span></a></li>
                            <li id="navi02"><a href="javascript:void(0);" @click.prevent="fn_movePage('LCTA4C01')">나의 지출<span class="pin purple">NEW</span></a></li>
