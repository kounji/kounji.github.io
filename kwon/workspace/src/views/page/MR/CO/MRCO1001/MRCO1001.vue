...
* @ 서비스경로 : 설정/관리 > 알림관리
* @ 페이지설명 : 설정/관리 > 알림관리
* @ 파일명     : src/views/page/MR/CO/MRCO1001/MRCO1001.vue
* @ 작성자     : CS528069
* @ 작성일     : 2022-10-18
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
<template>
	...
	<div class="full_popup renewal" id="full_popup_01"> 
		...
		<a href="javascript:void(0);" class="btn_close" @click.prevent="closeAll('MRCO1001')"><span class="blind">팝업닫기</span></a>		
	</div>
	<!--// full popup E -->
</template>
