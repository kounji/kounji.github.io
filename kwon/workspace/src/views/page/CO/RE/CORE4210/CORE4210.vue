...
* @ 페이지설명 : 지역설정화면
* @ 파일명     : src/views/page/CO/RE/CORE4210/CORE4210.vue
* @ 작성자     : CS541013
* @ 작성일     : 2025-04-02
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
*_________________________________________________________________________
* 2025-04-02              CS541013                 최초작성
*************************************************************************/
-->
<template>
	<div class="full_popup renewal" id="full_popup_01"> 
		<div class="popup_header">    
			<h1>소재지 설정</h1>	
            <a href="javascript:void(0);"  class="prev" v-on:click.prevent="fn_moveBack()" v-if="backYn"><span class="blind">이전화면</span></a>			
		</div>

        <div class="popup_content com_no_bottom">
            <div class="custom_check_list sel_local">
                <div class="com_inner"> 
                    <template v-if="selProvC.length > 0">
                    <div class="com_radio_type01">
