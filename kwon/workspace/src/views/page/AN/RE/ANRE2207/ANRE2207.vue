...
/*************************************************************************
* @ 서비스경로 : 제휴서비스 > NH콕부동산
* @ 페이지설명 : 제휴서비스 > NH콕부동산 > 메인 > 관심부동산 등록
* @ 파일명     : src/views/page/AN/RE/ANRE2207/ANRE2207.vue
* @ 작성자     : CS528053
* @ 작성일     : 2022-08-18
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
    ...
    <div class="full_popup renewal" id="full_popup_01"> 
		...
		<div class="popup_footer fixed">
			<div class="btn_full_box">
				<a href="javascript:void(0);" class="btn btn_mint" :class="btnOnOff" @click.prevent="intInteRlest()">등록</a>
			</div>
		</div>
                        ...
                        if(isJoin) {
                            ...
                            modalService.openSlidePagePopup(config_evtSlide).then(response => {
                                if(response === "evtYes") {
                                    ...
                                    modalService.alert("관심부동산이 등록되었습니다.").then(() => {
