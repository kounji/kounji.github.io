<!--
/*************************************************************************
* @ 서비스경로 : 마이농가 > 설정 > 농기계 상각 관리 > 농기계 상각 수정
* @ 페이지설명 : 농기계 상세
* @ 파일명     : src/views/page/AN/SZ/ANSZ2008/ANSZ2008.vue
* @ 작성자     : CS523299
* @ 작성일     : 2021-08-19 
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
* 2022-08-18              CS528061              고도화 및 파일명 변경(SZST2112 -> ANSZ2008)                
*************************************************************************/
-->
<template>
    <!-- full popup S -->
	<div class="full_popup renewal" id="full_popup_01"> 
		...
		<div class="popup_footer fixed">
			<div class="com_btnhalfbox_type02">
				<a href="javascript:void(0);" role="button" class="btn btn_grey" @click="closePage()" aria-disabled="false">취소</a>
				<a href="javascript:void(0);" role="button" class="btn btn_mint" @click="fn_editSaveDprcInfo()" aria-disabled="false">저장</a>
				<!-- btn_off 제거시 활성화 -->
			</div>
		</div>
		...
		methods: {
            ...
            getFmachDprcDtlInfo(){
				...
				apiService.call(config).then(response => {
                    ...
                    this.itemList   = response.itemList 	    // 작목목록
			...
			fn_editSaveDprcInfo() {
                ...
                const config = {
                    ...
                    data: {
                        ...
                        asetTrryDsc : this.$refs['asetTrryDsc'].checked === true ? '03' : '01'          // 자산영역구분코드(마이농가자산에서 등록할 경우 : 01.마이농가자산, 03.마이농가자산+기타자산)
                    }
                }
