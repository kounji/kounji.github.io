...
* @ 서비스경로 : 제휴서비스 > 영농일지 > 메인
* @ 페이지설명 : 영농일지 메인
* @ 파일명     : src/views/page/AN/SZ/ANSZ2002/ANSZ2002.vue
* @ 작성자     : 
* @ 작성일     : 2022-09-23
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
<template>
    ...
    <!-- <div class="com_tabmenu_type02">
        <sz-category type="FR"></sz-category>
    </div> -->  
        ...
        <an-sub-category type="FR"></an-sub-category>
...
export default {
    ...
    created() {
      ...
      console.log("[SZFR0001]created/(onLoad)년|월|일(currentYear|currentMonth|currentDay) =>>> ", this.currentYear, this.currentMonth, this.currentDay )    
      console.log("[SZFR0001]created/(onLoad)년월(rszYYYYMM) =>>> ", this.rszYYYYMM )    
      console.log("[SZFR0001]created/(onLoad)년월Slide 선택/년월(selrszYYYYMM) =>>> ", this.selrszYYYYMM )    
      console.log("[SZFR0001]created/(onLoad)년월Slide 선택이전/년월(nowYYYYMM) =>>> ", this.nowYYYYMM )    
      console.log("[SZFR0001]created/(onLoad)년월Slide 선택이전/일(nowDay) =>>> ", this.nowDay )    
      console.log("[SZFR0001]created/(onLoad)년월Slide 선택이전/일(nowDt) =>>> ", this.nowDt )    
    ...
    mounted() {
     ...
     methods: {
        initComponent(param = {}) {
            ...
            console.log("[SZFR0001]initComponent/popId=>> ", this.popId)

            console.log(">>> [SZFR0001]methods(Start) <<<")
            ...
            console.log("[SZFR0001]initComponent/마이데이터고객번호=>> ", this.getUserInfo('mydtCusno'))
            console.log("[SZFR0001]initComponent/이미지 초기화=>> ", this.isPstnYn)
            console.log("[SZFR0001]initComponent/나의농dSelect 초기화=>> ", this.myFarmTxt)
            console.log("[SZFR0001]initComponent/조회구분코드(여부)=>> ", this.isInqDsc)
            console.log("[SZFR0001]initComponent/년|월=>> ", this.currentYear, this.currentMonth )    

            console.log("[SZFR0001]initComponent/경제통합상품대분류코드=>> "+this.varNaWrsLclc)
            console.log("[SZFR0001]initComponent/경제통합상품중분류코드=>> "+this.varNaWrsMclc)
            console.log("[SZFR0001]initComponent/경제통합상품소분류코드=>> "+this.varNaWrsSclc)
            ...
            console.log(">>> [SZFR0001]methods(End) <<<")
        ...
        fn_getAsetList(){
            ...
            console.log(">>> [SZFR0001]fn_getAsetList(Start) <<<")
            ...
            apiService.call(config).then(response => {
                ...
                console.log("[SZFR0001]fn_getAsetList/동의여부(response.agrYn)=>> ", response.agrYn)
                console.log("[SZFR0001]fn_getAsetList/동의여부(agrYn)=>> ", agrYn)
                ...
                console.log("[SZFR0001]fn_getAsetList/정보제공여부(certAgrYn)=>> ", this.certAgrYn)

                if(!this.certAgrYn) {
                    console.log("[SZFR0001]fn_getAsetList/certAgrYn=>> 미동의(false)~ ")
                    ...
                    modalService.openPopup(config_pop).then(response => {
                        ...
                        console.log("[SZFR0001]fn_getAsetList/response=>> "+response)

                        if(response === 'noSeemyFarm')   //[다시 선택하지 않기]
                        {
                            console.log("[SZFR0001]fn_getAsetList/ 다시선택하지 않기(noSeemyFarm)~ ")
                        ...
                        {
                            console.log("[SZFR0001]fn_getAsetList/ goSeemyChkFarm(동의서 선텍 맟 서비스 이용하기 선택시~~) ")

                            this.fn_openSlidePop()   
                        } else  if(response === 'goSeemyNonChkFarm' || response === 'goSeemyFarm')   //[미동의]인 경우 or [닫기]버튼 선택시
                        {
                            console.log("[SZFR0001]fn_getAsetList/ goSeemyChkFarm(동의서 미선텍 맟 서비스 이용하기 선택시~~) ")
                    ...
                    {
                        console.log(">>> [SZFR0001]initComponent/[다시보지 않기] 미선택시~ <<< ")
                        ...
                        if( commonService.getStorage('noSeemyFarmClaSign' + this.getUserInfo('chnl') + this.getUserInfo('mydtCusno') + 'Sign') !== 'Y' ) {
                            console.log(">>> [SZFR0001]initComponent/약관동의 안내문 확인 선택시11~ <<< ")
                            
                            this.fn_openSlidePop()
                        } else {
                            console.log(">>> [SZFR0001]initComponent/약관동의 안내문 확인 선택시22~ <<< ")
                            
                             this.fn_init()
                        }
                    } else {
                        console.log(">>> [SZFR0001]initComponent/[다시보지 않기] 선택시~ <<< ")
            ...
            console.log(">>> [SZFR0001]fn_getAsetList(End) <<<")
        },
        ...
        */
        selectMonth(){
            ...
            console.log(" >>> [SZFR0001]selectMonth(Start) <<<")    
            ...
            console.log(" >>> [SZFR0001]selectMonth(End) <<<")    
        ...
        getSearchList(flag) {
            ...
            console.log(">>> [SZFR0001]getSearchList(Start) <<< ")

            console.log("[SZFR0001]getSearchList/(변수)flag=>> "+flag)
            console.log("[SZFR0001]getSearchList/(변수)마이농장여부=>> "+this.isInqDsc)
            console.log("[SZFR0001]getSearchList/(변수)경제통합상품대분류코드=>> "+this.varNaWrsLclc)
            console.log("[SZFR0001]getSearchList/(변수)경제통합상품중분류코드=>> "+this.varNaWrsMclc)
            console.log("[SZFR0001]getSearchList/(변수)경제통합상품소분류코드=>> "+this.varNaWrsSclc)
            console.log("[SZFR0001]getSearchList/(변수)간편일지여부=>> "+this.culplAreaUntC)
            ...
            console.log("[SZFR0001]config=>> ", config)
            ...
            apiService.call(config).then(response => {
                ...
                console.log("[SZFR0001]/(변수)조회년월(inqYm)=>> ", this.repVarInqYm)
                ...
                console.log("[SZFR0001]/(변수)일자별 조회건수(dtbyInqCn)=>> ", this.repVarDdtbyInqCn)
                console.log("[SZFR0001]fn_RstInfo/dtbyInqList =>>"+JSON.stringify(this.dtbyInqList))
                ...
                console.log(">>> [SZFR0001]getSearchList(End) <<< ")
            })        
        },
		...
		fn_getAbiCulplList(){
            ...
            const config ={
             ...
             apiService.call(config).then(response => {
                ...
                console.log("[SZFR0001]fn_getAbiCulplList/response.abiCulplList =>> "+JSON.stringify(response.abiCulplList))

                console.log("[SZFR0001]fn_getAbiCulplList/this.myFarmTxt=>> "+this.myFarmTxt)
             ...
             console.log(">>> [SZFR0001]fn_getAbiCulplList(End) <<< ")    
        ...
        */
        fn_slidmyFarmPopOpen() {
            ...
            console.log(">>> [SZFR0001]fn_slidmyFarmPopOpen(Start) <<<")  

            this.culplAreaUntC ='ALL'        
            console.log("[SZFR0001]fn_slidmyFarmPopOpen/(변수)culplAreaUntC=>> "+this.culplAreaUntC)  
            console.log("[SZFR0001]fn_slidmyFarmPopOpen/(입력)마이데이터고객번호=>> "+this.getUserInfo('mydtCusno'))  
            ...
            modalService.openSlidePagePopup(config).then(response => {
				...
				console.log("[SZFR0001](변수)상품분류코드(대)=>> "+this.varNaWrsLclc)  
				console.log("[SZFR0001](변수)상품분류코드(중)=>> "+this.varNaWrsMclc)  
				console.log("[SZFR0001](변수)상품분류코드(소)=>> "+this.varNaWrsSclc)  
				console.log("[SZFR0001](변수)상품분류명=>> "+this.varNaWrsSclfnm)  
				console.log("[SZFR0001](변수)재배지지역코드|재배지지역명=>> "+this.varCulplRgnC, this.varCulplRgnNm)  

                this.varNaWrs = this.varNaWrsLclc+this.varNaWrsMclc+this.varNaWrsSclc
				console.log("[SZFR0001](변수)상품분류코드(대/중/소)=>> "+this.varNaWrs)  
				...
				console.log("[SZFR0001](변수)나의농장여부=>>"+this.isInqDsc)  

                this.myFarmTxt = this.varNaWrsSclfnm   //(변수)상품분류명 = (response)상품분류명(소분류)
				console.log("[SZFR0001](변수)상품분류명=>>"+this.myFarmTxt)  
                //                
            ...
            console.log(">>> [SZFR0001]fn_slidmyFarmPopOpen(End) <<<")  
		},
        ...
        */
        fn_openFarmDailyPop(flag1, flag2, flag3, flag4, flag5, flag6, flag7, flag8, flag9, flag10, flag11, flag12, flag13) {  
            ...
            console.log(">>> [SZFR0001]fn_openFarmDailyPop(Start) <<< ")
            ...
            //  글쓰기 이미지 보여주지 않기
            this.isPstnYn = false
            console.log("[SZFR0001]fn_openMyFarmDetailPop/(전)isPstnYn=>>"+this.isPstnYn)

            modalService.openPopup(config).then(response => {

                console.log('[SZFR0001]response=>> ' , response)

                if(response === 'complete'){         
                    this.isPstnYn = true  //글쓰기 이미지 보여주기    
                    console.log("[SZFR0001]fn_popupSel/(후)isPstnYn=>> "+this.isPstnYn)
            ...
            console.log(">>> [SZFR0001]fn_openFarmDailyPop(End) <<< ")
        ...
        */
        fn_openEconormyPop(flag21, flag22, flag23, flag24, flag25, flag26, flag27, flag28, flag29, flag30, flag31, flag32, flag33) {
            ...
            console.log(">>> [SZFR0001]fn_openEconormyPop(Start) <<< ")
            ...
            //  글쓰기 이미지 보여주지 않기
            this.isPstnYn = false
            console.log("[SZFR0001]fn_openEconormyPop/(전)isPstnYn=>>"+this.isPstnYn)
            ...
            console.log(">>> [SZFR0001]fn_openEconormyPop(End) <<< ")            
        ...
        */
        fn_openPop() {
            ...
            console.log(">>> [SZFR0001]fn_openPop(Start) <<< ")

            console.log("[SZFR0001]fn_openPop/(변수)선택 년월=>> "+this.selrszYYYYMM)
            console.log("[SZFR0001]fn_openPop/(변수)현재 년월=>> "+this.rszYYYYMM)
            console.log("[SZFR0001]fn_openPop/(변수)년/월/일=>> "+this.currentYear, this.currentMonth, this.currentDay)
            ...
            console.log(">>> [SZFR0001]fn_openPop(End) <<< ")
        ...
        */
        fn_bfraftClamp(flag){
            console.log(">>>>>>> [SZFR0001]fn_bfraftClamp(Start) <<<<<<< ")
        ...
        fn_openSlidePop() {
            ...
            console.log("[SZFR0001]fn_openSlidePop(Start) ")
            ...
            modalService.openSlidePagePopup(config).then(response => {
                ...
                console.log("[SZFR0001]fn_openSlidePop/response=>> "+response)

                if(response === 'noSeemyFarmClaSign')
                {
                    console.log("[SZFR0001]fn_openSlidePop/ 여기1(noSeemyFarm)~ ")
            ...
            console.log("[SZFR0001]fn_openSlidePop(End) ")
        },
        // kimhc_20220920 알매이트 
        // 토글 ( 강낭콩(울타리콩), 밭벼 ) 
