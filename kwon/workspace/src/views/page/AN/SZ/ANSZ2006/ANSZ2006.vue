...
* @ 파일명     : src/views/page/AN/SZ/ANSZ2006/ANSZ2006.vue
* @ 작성자     : 
* @ 작성일     : 2021-06-04
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
<template>
    <div class="full_popup renewal" id="full_popup_01"> 
        ...
        <div class="popup_content com_no_bottom"><!-- 하단 버튼 없을때 com_no_bottom -->
            ...
            <div class="com_inner com_line_type01 com_top_type03 custom_box_com_top_type03">
                <div class="msg_list_box">

                    <!-- <div class="new_tit_area"> -->
                    <div class="new_tit_area custom_new_tit_area">
                        <div class="tit"><span>{{fmach.fmachWrsnm}}</span></div>
                    </div>
                    <!-- <ul class="list_type_02"> -->
                    <ul class="list_type_02 custom_list_type_02">
                        <li>
                            <dl>
                                <dt>
                                    <em>업체</em>
                    ...
                    <!-- <template  v-if="lnLmtAm != 0">
                        ...
                        <p class="dot_msg mt18">농기계정보 및 대출한도는 2020년 7월 1일 기준으로 정확한 정보는 영업점으로 문의하시기 바랍니다.</p>
                    </template> -->
                    <!--대출한도 금액이 존재하지 않을 경우-->
                    <!-- <template v-else>
                        <div class="com_gray_box">
                    ...
                    <template  v-if="lnLmtAm != 0">
                        ...
                        <div class="custom_box">
                            <p class="dot_msg">농기계정보 및 대출한도는 2020년 7월 1일 기준으로 정확한 정보는 영업점으로 문의하시기 바랍니다.</p>
                        </div>
                    </template>
                    <!--대출한도 금액이 존재하지 않을 경우-->
                    <template v-else>
            ...
            <template  v-if="lnLmtAm != 0">
                <!--Tab(Start)-->
                <div class="com_inner">
                    <div id="tabs" class="com_tabmenu_type03">
                        <ul>
                            <li v-for="(tab, index) in tabs" :key="index" :class="[currentTab===index?'on':'']">
                                <a href="javascript:void(0);" role="button" v-on:click.prevent="TabSel(index)">{{tab}}</a></li>
                        </ul>
                    </div>
                </div>
                <!--Tab(End)-->
                ...
                <!--Tab0(대출받기)-->
                <div v-show="currentTab == 0" :class="currentTab == 0?'cmm-tab-panel on':''">   
                    <div class="com_inner">
                        <ul class="list_type_02 bl_dot_list custom_bl_dot_list">                    
                            <li>
                                <dl>
                                    <dt>
                                        <em>상환방식</em>
                        ...
                        <div class="com_input_type01" :class="rpybtnYn ? 'com_word3' : 'com_word1'">
                            ...
                            <a href="javascript:void(0);" role="button" class="com_btn_call" @click.prevent="fn_openSZFL2107" v-show="rpybtnYn"><span class="blind">팝업열기</span></a>
                        ...
                        <div class="com_input_type01 com_word2">
                            ...
                            <div class="del_txt">
                                <a href="javascript:void(0);" role="button" class="com_btn_delete2"><span class="blind">삭제</span></a>
                            ...
                            <div class="btn_price_group">
                                <button type="button" class="btn_price" @click.prevent="addMoney(5)" title="5만">+<strong>5</strong>만</button>
                                <button type="button" class="btn_price" @click.prevent="addMoney(10)" title="10만">+<strong>10</strong>만</button>
                                <button type="button" class="btn_price" @click.prevent="addMoney(100)" title="100만">+<strong>100</strong>만</button>
                                <button type="button" class="btn_price" @click.prevent="addMoney(1000)" title="1000만">+<strong>1000</strong>만</button>
                            </div>
                            <!--// 5만/ 10만 / 100만 / 1000만 -->
                        </div>

                        <!-- kimhc_20220919 변경된 부분 수정 -->
                        <!-- <div class="tit_dot_box"> -->
                            <!-- <div class="pop_tit"><span>대출제한</span></div> -->
                        <div class="tit_dot_box custom_box_tit_dot_box">
                            <strong class="com_pop_tit02 custom_box_tit">대출제한</strong>
                        ...
                        <!-- <div class="com_btn_area00">
                            <a href="javascript:void(0);" role="button" class="com_btn_more" v-on:click.prevent="calLoan" >
                                <span>계산하기</span>
                            </a>
                        </div> -->
                        <div class="com_btn_area custom_box mt20 mb60">
                            <a href="javascript:void(0);" class="com_btn_round com_btn_round01" role="button"  v-on:click.prevent="calLoan">
                    ...
                    <div v-show="calYN1">
                        <div id="loan_layer" class="result_cont">
                            <div class="com_inner">
                                <div class="available_money custom_available_money">
                                    <!-- 대출한도<em class="roboto">{{lnPsbAm/10000 | numberFilter}}</em><span>만원</span> -->
                                    대출한도<em class="roboto">{{lnPsbAm | numberFilter}}</em><span>만원</span>
                                </div>
                            </div>
                        </div>
                        <ul class="toggle_list_area loan_toggle_list_area custom_toggle_list_area">
                            <!--대출상세 Toggle-->
                            <li>
                            ...
                            <li>
                                <div class="toggle_list_box ">
                                    ...
                                    <ul class="view_list_box ">
                                        <li>
                                            <div class="custom_box_tit_wrap">
                                                <strong class="com_pop_tit02 custom_box_tit">대출금 상환 계획</strong>
                                            </div>
                                            <div class="com_tablearea_type01 custom_tbl01">
                                                <table class="com_tbl com_tbl2">
                                                    <!-- <colgroup>
                                                        <col style="width:8.3rem">
                                                    ...
                                                    <tfoot>
                                                        <tr class="com_bg_type01">
                                                            <td colspan="2">총 이자액</td>
                                                            <td colspan="3" class="txt_r com_point_blue">
                                                                <!-- <em class="roboto">{{totInt | numberFilter}}</em><span>원</span> -->
                                                                <em class="roboto">{{totInt*10000 | numberFilter}}</em><span>원</span>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                    <tbody>
                                                        <tr v-for="(rpln, index) in rplnList" :key="index">
                                                            ...
                                                            <td>{{rpln.mmPymAm*10000 | numberFilter}}</td>
                                                            <td v-if="rpln.mmPymPrn == 0">-</td>
                                                            <td v-else>{{numberFormat(rpln.mmPymPrn*10000)}}</td>
                                                            <td>{{rpln.mmPymInt*10000 | numberFilter}}</td>
                                                            <td>{{rpln.lnBac*10000 | numberFilter}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                        ...
                        <!--대출방법-->
                        <div class="com_inner">
                            <div class="loan_step_list_box custom_box_loan_step_list">
                ...
                <!--Tab1(목돈모으기)-->
                <div role="tabpanel" v-show="currentTab == 1" :class="currentTab == 1?'cmm-tab-panel pt27 pb76 on':''"> 
                    <div class="com_inner">

                        <div class="com_gray_box big_money custom_box_big_money">
                            <strong><em class="com_point_darkblue"><span class="num">{{lnLmtAm | numberFilter }}</span>만원</em> 을 모으고 싶다면</strong>
                            <span>농기계 실판매가격은 대출 한도액을 초과할 수 있습니다.</span>
                        </div>

                        <!--추후 이부분 수정~~-->
                        <div class="com_inputarea_type00 custom_box_inputarea01">
                            <div class="com_input_type01 com_word2">
                                ...
                                <div class="del_txt">
                                    <a href="javascript:void(0);" role="button" class="com_btn_delete2" style="display: none;"><span class="blind">삭제</span></a>
                                    <span class="com_inputtxtright2">만원</span>
                                </div>

                                <!-- kimhc_20220919 추가 -->
                                <!-- <p class="com_sum">1조 2,345억 6,789만원</p> -->
                                <p class="com_sum">{{fn_hanValue(mnPy)}}</p>

                                <!-- kimhc_20220919 추가 -->
                                <!-- 5만/ 10만 / 100만 / 1000만 -->
                                <div class="btn_price_group">
                                    <button type="button" class="btn_price" @click.prevent="addMoneyMnPy(5)" title="5만">+<strong>5</strong>만</button>
                                    <button type="button" class="btn_price" @click.prevent="addMoneyMnPy(10)" title="10만">+<strong>10</strong>만</button>
                                    <button type="button" class="btn_price" @click.prevent="addMoneyMnPy(100)" title="100만">+<strong>100</strong>만</button>
                                    <button type="button" class="btn_price" @click.prevent="addMoneyMnPy(1000)" title="1000만">+<strong>1000</strong>만</button>
                                </div>
                                <!--// 5만/ 10만 / 100만 / 1000만 -->
                            </div>

                            <div class="com_input_type01 com_word1">
                                <input required type="tel" id="com_input04" class="com_txtright_type01" autocomplete="off" maxlength="5" 
                                ...
                                <label for="com_input04">
                                    <em><span class="blind">필수입력</span></em>
                                    <span class="custom_box_txt_label_o">연 이자율</span>
                                </label>
                                <div class="del_txt">
                    ...
                    <!-- <div class="com_btn_area00">
                        <a href="javascript:void(0);" role="button" class="com_btn_more" v-on:click.prevent="callNeckMoney" >
                            <span>계산하기</span>
                        </a>
                    </div> -->

                    <!-- <div class="com_btn_area custom_box mt20 mb60">
                        <a href="javascript:void(0);" class="com_btn_round com_btn_round01" role="button"  v-on:click.prevent="callNeckMoney">
                            <span class="btn_calculation">계산하기 ㄴㅇㄹㄴㅇㄹ</span>
                        </a>
                    </div> -->
                    ...
                    <div class="popup_footer fixed">
                        <div class="btn_full_box">
                            <!-- 2022-08-19 : 글자명 변경 -->
                            <a href="javascript:void(0);" class="btn btn_mint" role="button" v-on:click.prevent="callNeckMoney">계산하기</a>
                        </div>
                    </div>

                    <!--[계산하기]하단 부분-->
                    <div class="result_cont mt30">
                            ...
                            <div class="com_top">
                                ...
                                <div class="com_box_type01 fin_info_wrap mt10 mb30">
                                    ...
                                    <div class="one_list">
                                        ...
                                        모이는 금액  <span class="color">{{numberToKorea(dueXpcPyAm*10000)}}</span>원
                                    </div>  
                                </div>
                            </div>
                                ...
                                <table class="com_tbl com_tbl">
                                    ...
                                    <tfoot>
                                        <tr class="com_bg_type01">
                                            ...
                                            <td class="txt_r com_point_blue"><em class="">{{numberToKorea(dueXpcPyAm*10000)}}</em><span>원</span></td>
                                        </tr>
                                    </tfoot>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="txt_r"><em class="">{{numberToKorea(dueAvtPrntt*10000)}}</em><span>원</span></td>
                                        </tr>
                                        <tr>
                                            <td>세전이자</td>
                                            <!-- <td class="txt_r"><em class="">{{numberToKorea(txbfInt)}}</em><span>원</span></td> -->
                                            <td class="txt_r"><em class="">{{numberToKorea(txbfInt*10000)}}</em><span>원</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <a href="javascript:void(0);" role="button" @click.prevent="closePopup" class="btn_close"><span class="blind">팝업닫기</span></a>	
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getData() 
        {
            ...
            this.lnLmtAm = this.numberFormat(this.fmach.lnLmtAm)   //대출한도금액 / 10000
        ...
        //대출받기 Tab-[계산하기]버튼 클릭
         calLoan(){
            ...
            } else if(t_fmachBuyAstmny > this.lnLmtAmNumber){
            ...
            const config ={
                ...
                data : {
                    ...
                    fmachBuyAstmny  : t_fmachBuyAstmny,        //(입력)농기계기구매보조금
        ...
        // kimhc_20220919 추가
        addMoney(money) {
            let tmpFmachBuyAstmny = Number(this.fmachBuyAstmny.split(",").join(""));
            
            // tmpFmachBuyAstmny += money * 10000;
            tmpFmachBuyAstmny += money;

            // 최대 금액 9,999,999,999 이상인 경우 최대값 고정
            if(tmpFmachBuyAstmny >= 9999999999) {
                tmpFmachBuyAstmny = 9999999999;
            }
            this.fmachBuyAstmny = String(tmpFmachBuyAstmny);
            this.addComma();
        },
        // kimhc_20220919 추가
        addMoneyMnPy(money) {
            let tmpMnPy = Number(this.mnPy.split(",").join(""));
            
            // tmpMnPy += money * 10000;
            tmpMnPy += money;

            // 최대 금액 9,999,999,999 이상인 경우 최대값 고정
            if(tmpMnPy >= 9999999999) {
                tmpMnPy = 9999999999;
            }
            this.mnPy = String(tmpMnPy);
            this.addCommaMnPy();
        },
        // 금액 천단위 쉼표 표시(kimhc_20220919 추가)
        addComma() {
            if(this.fmachBuyAstmny.length == 1 && this.fmachBuyAstmny == 0) {
                this.fmachBuyAstmny = this.fmachBuyAstmny.slice(0, -1)
            } else {
                this.fmachBuyAstmny = this.fmachBuyAstmny.replace(/[^0-9]/g,'').replace(/[ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/g,'')
                this.fmachBuyAstmny = this.fmachBuyAstmny.split(",").join("")
                this.fmachBuyAstmny = keyupNumFormat(this.fmachBuyAstmny)
            }
        },
        // 금액 천단위 쉼표 표시(kimhc_20220919 추가)
        addCommaMnPy() {
            if(this.mnPy.length == 1 && this.mnPy == 0) {
                this.mnPy = this.mnPy.slice(0, -1)
            } else {
                this.mnPy = this.mnPy.replace(/[^0-9]/g,'').replace(/[ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/g,'')
                this.mnPy = this.mnPy.split(",").join("")
                this.mnPy = keyupNumFormat(this.mnPy)
            }
        },
    },
    components : {
