...
/*************************************************************************
* @ 서비스경로 : 금융생활 > NH콕마이카
* @ 페이지설명 : 금융생활 > NH콕마이카 > 신차 검색
* @ 파일명     : src\views\page\AN\CA\ANCA2203\ANCA2203.vue
* @ 작성자     : CS528043
* @ 작성일     : 2022-08-10
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
			...
			<div class="com_inner">
				...
				<div class="custom_box_shadow custom_box_shadow2 vertical-car-wap pt10">
					<div class="custom_box">
						<!-- slide -->
						<strong class="com_pop_tit01 custom">내가 원하는 드림카를 추천 받아 보세요!</strong>
						...
						<div class="vertical_car slick_refresh">
							<div class="slider_wrap">
								<template v-if="newCarTopPopList.length > 0">
									<div class="tab_cont auto_play"> <!--auto_play -->
										<div role="tabpanel" class="cmm-tab-panel" v-for="(carInfo, idx1) in newCarTopPopList" :key="idx1">										
											<div class="slide">
												<a href="javascript:void(0);" role="button" @click.prevent="fn_goNewCarDetailPage(carInfo.carCtrimNo)">
													<div class="top_info_box type02 noBG hasdetail">
														<div class="car_top_wrap">
															<!-- 2022-09-05 : 마크업 수정 -->
															<div class="car_name">
																{{carInfo.carBrannm}} {{carInfo.carModlnm}}<br/>
																{{carInfo.carCtrimNm}}																
															</div>
															<div class="date"><em class="num">{{carInfo.carModlMktgDt |dateFilter('YYYY년 MM월')}} </em>기준</div>
															<!--// 2022-09-05 : 마크업 수정 -->
															<div class="car_pic">
																<img v-if="pdcaUserAgent == 'else'" src="@/assets/images/icon/car_new01.png" :alt="setAlt(carInfo.carBrannm, carInfo.carModlnm, carInfo.carCtrimNm)">
						...
						<div class="tab_radius">
							<ul role="button">
								<li v-for="(tabInfo, tabIdx) in carOilCList" :key="'tab1_' + tabIdx">
									<a href="javascript:void(0);" :data-tab-tooltip="'tooltip' + tabInfo.comnCVal " role="button" :class="selectTab == tabInfo.comnCVal ? 'active' : ''" @click.prevent="fn_selectTab(tabInfo.comnCVal)">{{tabInfo.comnCExpl}}</a>
								</li>
							</ul>
						</div>
					</template>
							...
							<template v-else>
								<div class="com_btn_area com_btn_round_flex">
									<template v-if="srchGbn1 === 'keyword'">
										<div class="custom_box_search_area">
											<div class="com_input_type02">
												...
												<a href="javascript:void(0);" class="com_btn_search" role="button" @click.prevent="fn_srchKeyWdCarList('G', 'init')"><span class="blind">검색</span></a>
											</div>
									...
									<template v-else>
										...
										<a href="javascript:void(0);" class="com_btn_round btn2" role="button" @click.prevent="fn_openSearch()">
											<span>맞춤 검색</span>
										</a>										
									</template>
								</div>
									...
									<template v-if="srchGbn2 === 'keyword'">
										<div class="custom_box_search_area">
											<div class="com_input_type02">
												...
												<a href="javascript:void(0);" class="com_btn_delete" style="display: none;"><span class="blind">삭제</span></a>
												<a href="javascript:void(0);" class="com_btn_search" role="button" @click.prevent="fn_srchKeyWdCarList('D', 'init')"><span class="blind">검색</span></a>
											</div>
											<div class="custom_box_btn">
												<a href="javascript:void(0);" class="btn_search" role="button" @click.prevent="fn_srchCtrl('')"><span>취소</span></a>
											</div>
									...
									<template v-if="srchGbn3 === 'keyword'">
										<div class="custom_box_search_area">
											<div class="com_input_type02">
												...
												<a href="javascript:void(0);" class="com_btn_delete" style="display: none;"><span class="blind">삭제</span></a>
												<a href="javascript:void(0);" class="com_btn_search" role="button" @click.prevent="fn_srchKeyWdCarList('L', 'init')"><span class="blind">검색</span></a>
											</div>
											<div class="custom_box_btn">
												<a href="javascript:void(0);" class="btn_search" role="button" @click.prevent="fn_srchCtrl('')"><span>취소</span></a>
											</div>
									...
									<template v-if="srchGbn4 === 'keyword'">
										<div class="custom_box_search_area">
											<div class="com_input_type02">
												...
												<a href="javascript:void(0);" class="com_btn_delete" style="display: none;"><span class="blind">삭제</span></a>
												<a href="javascript:void(0);" class="com_btn_search" role="button" @click.prevent="fn_srchKeyWdCarList('O', 'init')"><span class="blind">검색</span></a>
											</div>
											<div class="custom_box_btn">
												<a href="javascript:void(0);" class="btn_search" role="button" @click.prevent="fn_srchCtrl('')"><span>취소</span></a>
											</div>
					...
					<div class="car-tab car-tab01 mt30">
						<template v-if="addSrchCarList.length > 0">
										...
										<li :key="idx4">
											<a href="javascript:void(0);" role="button" @click.prevent="fn_goNewCarDetailPage(newCarInfo.carCtrimNo)">
												<dl>
													<dt>
														<p class="carname">
															{{newCarInfo.carBrannm}} {{newCarInfo.carModlnm}}<br/>{{newCarInfo.carCtrimNm}}
														</p>
														<p class="date">
															<em class="num">{{newCarInfo.carModlMktgDt |dateFilter('YYYY년 MM월')}} 기준</em>
														</p>
													...
													<a href="javascript:void(0);" role="button" @click.prevent="fn_goNewCarDetailPage(newCarInfo.carCtrimNo)">
														<dl>
															<dt>
																...
																<p class="date"><em class="num">{{newCarInfo.carModlMktgDt |dateFilter('YYYY년 MM월')}} 기준</em></p>
																<p class="carprice" v-html="fn_numberFormatKorAmt(newCarInfo.carCtrimSelAm)"></p>
															</dt>
															<dd>
																<img v-if="pdcaUserAgent == 'else'" src="@/assets/images/icon/car_new06.png" :alt="setAlt(newCarInfo.carBrannm, newCarInfo.carModlnm, newCarInfo.carCtrimNm)">
							...
							<div class="com_btn_area00 com_btn_area05">
								<a href="javascript:void(0);" class="com_btn_more com_btn_more2" @click.prevent="fn_showMoreList()" v-show="lsPageYn==='1'">
									<span>더보기</span>
								</a>
							</div>
