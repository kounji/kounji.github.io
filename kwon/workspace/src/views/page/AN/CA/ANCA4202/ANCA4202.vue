...
* 2025-02-27              CS541015              NH콕마이데이터 4.0 추진 개발 UI변경(ANCA2202.vue -> ANCA4202.vue)
*************************************************************************/
-->
<template>
	<!-- full popup S -->
...
import COAR4001                from '@/views/page/CO/AR/COAR4001/COAR4001'  // 자산등록(메인)
