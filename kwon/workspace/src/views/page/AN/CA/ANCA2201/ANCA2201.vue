...
/*************************************************************************
* @ 서비스경로 : 금융생활 > NH콕마이카
* @ 페이지설명 : 금융생활 > NH콕마이카 > 자동차관리
* @ 파일명     : src\views\page\AN\CA\ANCA2201\ANCA2201.vue
* @ 작성자     : CS528043
* @ 작성일     : 2022-08-16
************************** 수정이력 ****************************************
* 날짜                    작업자                 변경내용
...
<template>
	<page class="content-view mydata2023">
		<an-category-v2 type="ANCA"></an-category-v2>
		<!-- content S -->
					...
					<template v-if="carList.length > 0">
						...
						<div class="car_inner margin_s">
							<div class="bg_diary_cell car_buy blue_color"><!-- 2022-08-30 class 추가 blue_color -->
								<a href="javascript:void(0)" role="button" class="cell ico01" @click.prevent="fn_goPage('SZFL2101')">
									<span>융자를 통한</span>
